...
public class App {
  ...
  public static void createMenu() {
    Sandwich sandwich1 = new Sandwich(1, "BLT", 12.50, 925, false, new Date(4102462799L),
        new String[] { "Bacon", "lettuce", "tomato", "mayo" });
    Sandwich sandwich2 = new Sandwich(2, "PBJ", 7.35, 822, true, new Date(0L),
        new String[] { "peanut butter", "grape jelly", "honey" });
    Sandwich sandwich3 = new Sandwich(3, "Grilled Cheese", 8.25, 889, false, new Date(0L),
        new String[] { "mozzarella cheese", "provolone cheese", "cheddar cheese", "jack cheese" });
    Sandwich sandwich4 = new Sandwich(4, "Grilled Chicken", 9.25, 713, false, new Date(0L),
        new String[] { "chicken", "lettuce", "tomato", "pickles", "guacamole" });
    Sandwich sandwich5 = new Sandwich(5, "Meatball", 12.50, 934, false, new Date(0L),
        new String[] { "beef", "parmesan cheese", "mozzarella cheese", "olive oil", "marinara sauce" });
    Sandwich sandwich6 = new Sandwich(6, "Egg Salad", 10.15, 1100, false, new Date(1751601600L),
        new String[] { "eggs", "mayo", "mustard", "green onion", "celery", "dill" });
    Sandwich sandwich7 = new Sandwich(7, "Ruben", 12.50, 855, false, new Date(1685851200),
        new String[] { "corned beef", "swiss cheese", "sauerkraut", "Thousand Island dressing" });
    Sandwich sandwich8 = new Sandwich(8, "Turkey Club", 11.25, 795, false, new Date(0L),
        new String[] { "turkey", "bacon", "lettuce", "cheddar cheese", "tomato", "pickles", "mayo" });
    Sandwich sandwich9 = new Sandwich(9, "Cuban", 10.50, 750, false, new Date(1703998800L),
        new String[] { "ham", "roast pork", "swiss cheese", "pickles", "mustard" });
    Sandwich sandwich10 = new Sandwich(10, "Veggie", 9.25, 615, true, new Date(0L), new String[] { "cucumber", "tomato",
        "spinach", "lettuce", "bell pepper", "carrots", "sprouts", "guacamole", "hummus" });

    menu1.add(0, sandwich5);
    menu1.add(1, sandwich2);
    menu1.add(2, sandwich3);
    menu1.add(3, sandwich4);
    menu1.add(4, sandwich1);
    ...
    Map<Integer, Sandwich> menu = menu1.stream().collect(Collectors.toMap(Sandwich::getCalories, s -> s));

    // System.out.println(menu);
    for (Map.Entry<Integer, Sandwich> m : menu.entrySet()) {
